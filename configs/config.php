...
$php5TemplateAdminPath    = 'D:/AppServ/www/hummings/templates/insite';
$php5ImagePath		= 'D:/AppServ/www/hummings/images';
$php5_image_template_path	= 'D:/AppServ/www/hummings';
$php5RootAdminTempalteCPath		= 'D:/AppServ/www/hummings/insite/templates_c/%s';
$php5TemplateAdminFile    = 'D:/AppServ/www/hummings/insite/templates/%s/%s/%s';
$php5TemplateImg    = $php5WebPath .'/templates/%s/%s';
$php5TemplateFile    = 'D:/AppServ/www/hummings/templates/%s/%s/%s';
$php5_gzip            = true;
$localhost = 1;
/* $php5Config['db_type'] = 'mysql';
  ...
  $php5RootPath       = '/home/hummingss/public_html';
  $php5RootAdminPath        = '/home/hummingss/public_html/insite';
  $php5TemplateAdminPath    = '/home/hummingss/public_html/templates/insite';
  $php5ImagePath      = '/home/hummingss/public_html/images';
  $php5_image_template_path   = '/home/hummingss/public_html';
  $php5RootAdminTempalteCPath     = '/home/hummingss/public_html/insite/templates_c/%s';
  $php5TemplateAdminFile    = '/home/hummingss/public_html/insite/templates/%s/%s/%s';
  $php5TemplateImg    = $php5WebPath .'/templates/%s/%s';
  $php5TemplateFile    = '/home/hummingss/public_html/templates/%s/%s/%s';
