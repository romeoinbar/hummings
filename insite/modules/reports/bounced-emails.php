...
$tpl = sprintf($php5TemplateAdminFile, $language, 'reports', 'bounced-emails.tpl');
if(!is_file($tpl )) {
...
switch($task)
{
	case "search":
		...
		break;
	default:
		$time_start = date('01-m-Y', php5GMTTime());
		$time_end = date('d-m-Y', php5GMTTime());
		break;	
}
...
$smarty->assign('link_category', sefBuild($php5WebPath, 'index.php?o=bounced-emails', 0));
$smarty->assign('link_create', sefBuild($php5WebPath, 'index.php?o=bounced-emails&m=create', 0));
...
$smarty->assign('link1', sefBuild($php5WebPath, 'index.php?o=bounced-emails&m=registered_bought', 0));
$smarty->assign('link2', sefBuild($php5WebPath, 'index.php?o=bounced-emails&m=registered', 0));
$smarty->assign('action', sefBuild($php5WebPath, 'index.php?o=reports&m=bounced-emails&task=search', 0));
