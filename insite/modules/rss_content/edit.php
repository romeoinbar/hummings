...
$tpl = sprintf($php5TemplateAdminFile, $language, 'rss_content', 'edit.tpl');
if(!is_file($tpl )) {
...
$smarty->assign('action', sefBuild($php5WebPath, 'index.php?o=rss_content&m=edit&task=update&id='.$id, 0));
