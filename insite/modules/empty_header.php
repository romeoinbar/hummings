<head>
<link href="<?php echo $php5WebPath ; ?>/insite/templates/system/css/style.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $php5WebPath; ?>/insite/templates/system/css/forms.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo $php5WebPath ; ?>/templates/en/eshop/js/jquery.js" type="text/javascript"></script>
