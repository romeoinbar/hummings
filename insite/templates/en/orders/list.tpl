...
$(document).ready(function(){
	...
	var currentTab = $('#tabs ul li.active a').attr('id'); 	
	currentTab = currentTab.replace("block","");
	$(currentTab).show();
...
<div id="container">
  <div id="tabs">
    <ul>
      <li {if $task=='tab1'}class='active'{/if}><a href="{$url1}" id="#blocktab-1">New({$count})</a></li>
      <li {if $task=='tab2'}class='active'{/if}><a href="{$url2}" id="#blocktab-2">Processed({$count2})</a></li>     
      <li {if $task=='tab3'}class='active'{/if}><a href="{$url3}" id="#blocktab-3">Cancelled({$count3})</a></li>      
      <li {if $task=='tab4'}class='active'{/if}><a href="{$url4}" id="#blocktab-4">Resurrect({$count4})</a></li>      
       <li {if $task=='tab5'}class='active'{/if}><a href="{$url5}" id="#blocktab-5">Completed({$count5})</a></li>  
    </ul>
    <div id="tab-1"> 
    <p align="center" style="border-bottom:1px solid #fff; padding-bottom:10px; font-size:12px;">{$paging1}</p>
    <p>    
    ...
    <div id="tab-2"> 
     <p align="center" style="border-bottom:1px solid #fff; padding-bottom:10px; font-size:12px;">{$paging2}</p>
     <p>     
    ...
    <div id="tab-3"> 
     <p align="center" style="border-bottom:1px solid #fff; padding-bottom:10px; font-size:12px;">{$paging3}</p>
     <p>    
	<table border=0 width=100%>
     <tr>
       <th width="100" align=left>
    ...
    <div id="tab-4"> 
     <p align="center" style="border-bottom:1px solid #fff; padding-bottom:10px; font-size:12px;">{$paging4}</p>
     <p>      
	<table border=0 width=100%>
     <tr>
       <th width="100" align=left>
     ...
     <div id="tab-5"> 
      <p align="center" style="border-bottom:1px solid #fff; padding-bottom:10px; font-size:12px;">{$paging5}</p>
     <p>    
	<table border=0 width=100%>
     <tr>
       <th width="100" align=left>
