...
<div id="content"> 
  ...
  <div id="element-box">
    ...
    <table class="admintable">
      ...
      <tr>
        <td>Published:</td>
        <td ><input type="radio" id="publish1" name="publish" value="1" checked="checked"/><label for="publish1">Yes</label><input type="radio" id="publish0" name="publish" value="0"/><label for="publish0">No</label></td>
      </tr>
