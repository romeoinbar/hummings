...
<div class=forms >
  ...
  <div class=input><input type='text' name='price'  size=10 maxlength=10 class="required" value='{$obj->price}'> </div>
  ...
  <div class=input>
                   <input type='file' name='image' > <a rel="tooltip" title="Please resize the image before upload. Ideally width < 800px, height <500px"><div class=tooltip_mark></div></a> </div>
...
<div>
  ...
  <div class=input><textarea name=description_short cols=50 rows=6>{$obj->description}</textarea><a rel="tooltip" title="<img src='{$base_url}/images/product_description_short.jpg'>"><div class=tooltip_mark></div></a></div>
<div>
<div class=label>Quantity</div>
  ...
  <div class=input><input type='text' name='lead_time'  size=5 maxlength=5 class="required" value=0>
  ...
  <div class=input><input type='text' name='available_date'  size=10 maxlength=10 class="required" value="{$today}">
