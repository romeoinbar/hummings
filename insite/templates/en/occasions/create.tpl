...
<div class=forms >
  ...
  <div class=input><input type='text' name='occasions_code'  size=10 maxlength=10 class="required"> </div>
  ...
  <div class=input><textarea name=description cols=50 rows=9></textarea><a rel="tooltip" title="<img src='images/category_sample.jpg'>"><div class=tooltip_mark></div></a></div>
