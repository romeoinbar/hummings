...
{include_php file="$php5RootAdminPath/modules/main/header.php"}
  ...
  <div style="padding:10px;">
    <div class="page_header"><span class="pathway">HOME &gt; </span>ADD NEWS CATEGORY</div>
    <div class="outer-form">
      ...
      <table border="0" cellpadding="0" cellspacing="5" width="100%">
        ...
        <tr>
          <td></td>
          <td><input type="submit"  value="Create" class="button_class" />&nbsp;<input type="button" value="back" onClick="window.location.href='{$link_return}'"  class="button_class" /></td>
        </tr>
      </table>          
  	</div>
	</div>
