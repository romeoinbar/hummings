...
INSERT INTO `tbl_message` VALUES ('2', '1', 'Congratulations & Best Wishes On The Arrival Of Your Wonderful Newborn Twin Girl', '50');
...
INSERT INTO `tbl_message` VALUES ('4', '1', 'A New Little Boy to Brighten Your World! He couldn&#39;t have happened to a nicer family! Congratulations to Everyone! ', '50');
INSERT INTO `tbl_message` VALUES ('5', '1', 'Congratulations on the arrival of your newborn baby boy', '50');
...
INSERT INTO `tbl_newsletter_mail` VALUES ('2', 'A User unsubscribed from all your lists : {user:email}', '<p>Hello {subtag:name},</p><p>The user {user:name} : {user:email} unsubscribed from all your lists</p><p>Subscription : {user:subscription}</p><p>{survey}</p>', '', '1', null, null, '', '', '', '', 'notification', '0', null, 'notification_unsuball', null, '1', '0', null, null, null, null, null, null, null);
INSERT INTO `tbl_newsletter_mail` VALUES ('3', 'A User unsubscribed : {user:email}', '<p>Hello {subtag:name},</p><p>The user {user:name} : {user:email} unsubscribed from your list</p><p>Subscription : {user:subscription}</p><p>{survey}</p>', '', '1', null, null, '', '', '', '', 'notification', '0', null, 'notification_unsub', null, '1', '0', null, null, null, null, null, null, null);
INSERT INTO `tbl_newsletter_mail` VALUES ('4', 'A User refuses to receive e-mails from your website : {user:email}', '<p>The User {user:name} : {user:email} refuses to receive any e-mail anymore from your website.</p><p>Subscription : {user:subscription}</p><p>{survey}</p>', '', '1', null, null, '', '', '', '', 'notification', '0', null, 'notification_refuse', null, '1', '0', null, null, null, null, null, null, null);
...
INSERT INTO `tbl_newsletter_mail` VALUES ('6', 'AcyMailing Cron Report {mainreport}', '<p>{report}</p><p>{detailreport}</p>', '', '1', null, null, '', '', '', '', 'notification', '0', null, 'report', null, '1', '0', null, null, null, null, null, null, null);
INSERT INTO `tbl_newsletter_mail` VALUES ('7', 'A Newsletter has been generated : \"{subject}\"', '<p>The Newsletter issue {issuenb} has been generated : </p><p>Subject : {subject}</p><p>{body}</p>', '', '1', null, null, '', '', '', '', 'notification', '0', null, 'notification_autonews', null, '1', '0', null, null, null, null, null, null, null);
...
INSERT INTO `tbl_newsletter_mail` VALUES ('9', 'test', '', 'test', '0', null, '1339128158', 'test', 'test@test.com', 'test', 'test@test.com', 'news', '1', '62', 'test', null, '0', '0', '5fa48db17746903edda5010f28213749', null, null, null, '', '', null);
...
INSERT INTO `tbl_order` VALUES ('50', '2012-06-07', 'Z101', '', '2000', '13', '01', 'Z002', '6', '0007000006', 'Mr', 'Ali', '12', '05-123', 'Far East Building', '123465, FEB', '', '', '', '123465', '', 'SG', '654321001', '654321001', '1', '0', '1', '7000006', 'Ali', '0', '', '', 'ali@ali.com', 'I', '', '', '', '', '', '0', '0', '0', '', '0', '', '0', '', '0.00', '', '0.00', '', '0.00', '', '0.00', '0', '', '0', '0', '', '0', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', '36', '0', '0', '0');
...
INSERT INTO `tbl_order_delivery` VALUES ('36', '6', '2012-06-07', '2012-06-07', '10 pm - 11 pm', 'Mr Lee', 'Mr Ali', 'Congratulations & Best Wishes On The Arrival Of Your Wonderful Newborn Twin Girl', '1', '0', 'Call before delivery.\n	', '25.00', '0', '0', '0', 'Mr', 'Lee', '', '219', '#10-605', '', 'Jurong East St 21', '', '', '600219', 'SG', '', '96938443', '', 'lee@ua-consultants.com', '0');
...
INSERT INTO `tbl_order_item` VALUES ('35', '50', '9', '', 'HNB114B', '1', '1', '0', '', '50.00', '', '0.00', '', '0.00', '', '0.00', '0', '0', '0', '0', '0', '0', '0');
...
INSERT INTO `tbl_product` VALUES ('8', '0', '2', 'HNB114A', 'Beautiful Baby (Girl)', '50.00', '\r\nÂ·Birdâ€™s Nest Wild Ginseng with White Fungus & Rock Sugar 6x70g\r\nÂ·4pc Shears Baby Wear Deluxe Gift Set\r\nÂ·Packaged with Cheerful Sunflowers ', '\r\nÂ·Birdâ€™s Nest Wild Ginseng with White Fungus & Rock Sugar 6x70g\r\nÂ·4pc Shears Baby Wear Deluxe Gift Set\r\nÂ·Packaged with Cheerful Sunflowers ', 'images/product/8.JPG', '0', '0', '0', '0', '1', '0', '2012-06-03', '2012-06-03');
...
INSERT INTO `tbl_product_category` VALUES ('210', '1', 'SR', '202', 'Speedy Recovery', '', '', '1', '50', '1');
INSERT INTO `tbl_product_category` VALUES ('211', '2', 'SW', '202', 'Secretary&#92;&#39;s Week', '', '', '1', '50', '1');
INSERT INTO `tbl_product_category` VALUES ('212', '1', 'TD', '202', 'Teacher&#92;&#39;s Day', '', '', '1', '50', '1');
