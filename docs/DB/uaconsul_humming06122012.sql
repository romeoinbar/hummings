...
-- ----------------------------
INSERT INTO `tbl_banner` VALUES ('1', 'images/banner/1.jpg', '', '0', '1');
...
INSERT INTO `tbl_banner` VALUES ('5', 'images/banner/5.jpg', '', '1', '50');
...
CREATE TABLE `tbl_cart_rating_votes` (
  ...
  UNIQUE KEY `i_cart_product_id` USING BTREE (`product_id`,`created_by`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Stores all ratings for a product';
...
-- ----------------------------
INSERT INTO `tbl_history_logs` VALUES ('1', '1', '1', 'DELETE \n FROM #__category \n WHERE id IN () AND type = 2', '127.0.0.1', '1339517939');
INSERT INTO `tbl_history_logs` VALUES ('2', '1', '1', 'DELETE \n FROM #__category \n WHERE id IN (1) AND type = 2', '127.0.0.1', '1339517973');
INSERT INTO `tbl_history_logs` VALUES ('3', '1', '1', 'DELETE \n FROM #__category \n WHERE id IN (1) AND type = 2', '127.0.0.1', '1339518000');
INSERT INTO `tbl_history_logs` VALUES ('4', '1', '1', 'DELETE \n FROM #__rss \n WHERE id IN (1) ', '127.0.0.1', '1339518683');
...
-- ----------------------------
INSERT INTO `tbl_newsletter_user_group` VALUES ('3', 'group 2', '2;3;6;7', 'lee@ua-consultants.com;brightleee@hotmail.com;ali@ali.com;Test@noel.com.sg', '0');
...
-- Records of tbl_rss
-- ----------------------------
INSERT INTO `tbl_rss` VALUES ('2', '2', 'test', 'test', 'www.google.com', '13/06/2012', '', '1');
INSERT INTO `tbl_rss` VALUES ('3', '2', 'test 1', 'test', 'www.google.com', '13/06/2012', '', '1');
