...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td style="line-height:20px;">Title: <span style="color:#000;">{$obj->title}</span> <br />
      ...
      Message to: <span style="color:#000;">{$message_receiver}</span><br />
      Message: <span style="color:#000;">{$message_content}</span><br />
      Message from: <span style="color:#000;">{$message_sender}</span><br /></td>
  </tr>
  <tr>
