<div style="border-bottom:1px solid #ccc; padding:5px; padding-left:15px;"><a href="{$php5WebPath}/mobile-cart/" style="text-decoration:none;">Home</a> - <a href="{$url_my_account}" style="text-decoration:none;">My account</a> - <span style="color:#b84c86;">Address Book</span></div>
<div style="margin:15px;">
<div style="background-color:#fef2fa; height:35px; line-height:35px;">
...
{foreach from=$address_books item=address_book}
	...
	<div class="toggle_container">
		<div class="box">
		<p><strong>Title:</strong> {$address_book->title}</p>
...
{/if}
            ...
            <p><strong>Fax Number:</strong> {$address_book->pre_fax} {$address_book->mid_fax} {$address_book->fax}</p>
