                  ...
                  <tr>
                    <td width="380" valign="top" style="padding-right:20px;"><p><strong>Your Personal Details</strong></p>
                      ...
                      <p>Mobile Number:*<br />
                        ...
                        <input name="telephone1" type="text" class="digits required" value="{$obj->telephone1}" placeholder="Phone number" />
                      </p>
                      <p>Work Number:<br />
                        <input name="pre_telephone2" type="text"  class="digits" value="{$obj->pre_telephone2}" size="10" />
                        <input name="mid_telephone2" type="text"  class="digits" value="{$obj->mid_telephone2}" size="10" />                        
                        <input name="telephone2"  value="{$obj->telephone2}" />
                      </p>
                      <p>Fax:<br />
                        <input name="pre_fax" type="text"  class="digits" value="{$obj->pre_fax}" size="10" />
                        <input name="mid_fax" type="text"  class="digits" value="{$obj->mid_fax}" size="10" />                        
                    ...
                    <td valign="top" style="padding-left:20px;"><p><strong>Your Address</strong></p>
                      ...
                      <p>Postal Code* / Country<br />
                        ...
                        <span class="hiddenCountry">{$country}</span>
                      </p>
