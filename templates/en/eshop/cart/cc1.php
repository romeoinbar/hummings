...
<input type="hidden" value="" name="newsletter_phone" />
...
<tr>
  <td colspan="5" valign=mivddle><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td style="color:#a90061;">* To avoid double  billing, please click the button <strong>&lsquo;Make Payment&rsquo;</strong> only ONCE and allow payment to  take up to 60 seconds for processing.<br />
* All debit and credit cards accepted. Customers do not need to have a PayPal account to make your payment through PayPal.
</td>
      </tr>
  </table></td>
  </tr>
...
function checkNewsletterAgree(frm){
    ...
    id = document.getElementById('newsletter_phone');
    if(id.checked) {
        frm.newsletter_phone.value = 1;
    }
	return true;
}
