...
$discounted = 0;
               ...
               if (have_product_type_in_cart(1)&&!$php5Session->getVar('existed'))
               {
	            $order = generate_order(1);

                }
               if (have_product_type_in_cart(2)&&!$php5Session->getVar('existed'))
               {

	            $order = generate_order(2);

               }
              if (have_product_type_in_cart(4)&&!$php5Session->getVar('existed'))
              {

	           $order = generate_order(4);

              }
             if (have_product_type_in_cart(5)&&!$php5Session->getVar('existed'))
             {
	  ...
	  $coupon->updateDB(add_prefix('coupon'), 'coupon_code', $php5Session->getVar('coupon_code') );
	   ...
	   if ($recipients!= null)
	   {
            ...
            foreach ($recipient as $r )
	        {
			   ...
			   if (have_product_type_recipient_in_cart(1, $r))
               {
				 $d++;
				 echo '1';
				 $delivery_line++; 
			   ...
			   if (have_product_type_recipient_in_cart(2, $r))
               {
				 $d++;
				 echo '2';
				 $delivery_line++; 
			   ...
			   if (have_product_type_recipient_in_cart(3, $r))
               {
				 $d++;
				 echo '3';
				 $delivery_line++; 
			   ...
			   if (have_product_type_recipient_in_cart(4, $r))
               {
				 $d++;
				 echo '4';
				 $delivery_line++; 
			   ...
			   if (have_product_type_recipient_in_cart(5, $r))
               {
				 $d++;
				 echo '5';
				 $delivery_line++; 
