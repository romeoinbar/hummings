              ...
              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px; margin-bottom:20px;">
                  <tr>
                    <td width="380" valign="top" style="padding-right:20px;"><p><strong>Your Personal Details</strong></p>
                      ...
                      <p>Mobile Number:*<br />
                        <input name="pre_telephone1" type="text"  class="digits" value="{$obj->pre_telephone1}" size="5" />
                        <input name="mid_telephone1" type="text"  class="digits" value="{$obj->mid_telephone1}" size="5" />                       
                        <input name="telephone1" type="text" class="digits required" value="{$obj->telephone1}" />
                      </p>
                      <p>Work Number:<br />
                        <input name="pre_telephone2" type="text"  class="digits" value="{$obj->pre_telephone2}" size="5" />
                        <input name="mid_telephone2" type="text"  class="digits" value="{$obj->mid_telephone2}" size="5" />                        
                        <input name="telephone2"  value="{$obj->telephone2}" />
                      </p>
                      <p>Fax:<br />
                        <input name="pre_fax" type="text"  class="digits" value="{$obj->pre_fax}" size="5" />
                        <input name="mid_fax" type="text"  class="digits" value="{$obj->mid_fax}" size="5" />                        
                    ...
                    <td valign="top" style="padding-left:20px;"><p><strong>Your Address</strong></p>
                      ...
                      <p>Street*<br />
                        <input name="address1" type="text" class="normal_textinput required" id="" value="{$obj->address1}" />
                      </p>
                      <p>City / State<br />
                        <input name="city" type="text" class="" id="textfield34"  class="required" value="{$obj->city}" />
                        <input name="state" type="text" class="" id="textfield34"  class="required" value="{$obj->state}" />                        
                      </p>
                      
                      <p>Postal Code* / Country<br />
                        <input name="postcode" type="text" class=" required" id="textfield35"  value="{$obj->postcode}" />
