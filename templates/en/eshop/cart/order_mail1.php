    ...
    {foreach from=$order_items[$d] item=order_item}
     ...
     <table width="330"  border="0" cellpadding="4" cellspacing="0" >
      ...
      <tr>    
        <td  > Total Rate </td>   
        <td width=20 >&nbsp;  </td>        
        <td>{$order_item->unit_price * $order_item->qty }</td>         
      </tr>
...
<td valign=top>
  <div style='width:330px; float:left; margin:5px;'>
   <div style=" padding:5px 15px; font-family:Arial, Helvetica, sans-serif;font-size:14pt;color:#c414141;background-color:#e4e4e5" colspan=10><b>Delivery Information</b></div>
    ...
    <tr>
       <td colspan=3  align=right>Address</td>      
       <td></td>
       <td>{$delivery->shipto_block } {$delivery->shipto_unit } {$delivery->shipto_unit } {$delivery->shipto_building } {$delivery->shipto_address1 } {$delivery->shipto_address2 } </td>         
    </tr>
    <tr>
...
<div style='width:330px; float:right; margin:5px;'>
   <div style=" padding:5px 15px;  font-family:Arial, Helvetica, sans-serif;font-size:14pt;color:#c414141;background-color:#e4e4e5" colspan=10><b>Billing Information</b></div>
    ...
    <tr>
       <td colspan=3  align=right>Address</td>      
       <td></td>
       <td>{$order->block } {$order->unit } {$order->unit } {$order->building } {$order->address1 } {$order->address2 } </td>         
    </tr>
...
<br />
<br />
<p>Should  you require any assistance with regards to your order, please email us at: <a href="mailto:online@humming.com.sg">online@humming.com.sg</a> and our customer  service officer will be in touch with you shortly.<br />
  <br />
  Business hours: Monday to Friday : 9.00am to 6.15pm Saturday : 9.00am to 2.00pm</p>
<br />
<br />


<img src="{$php5WebPath}/images/email/footer.jpg" >
