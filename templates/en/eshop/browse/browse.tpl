<table width="198" align="left" style="margin-bottom:10px;">
<tr>
 <td>
 <div style='width:198px; height:198px; background:#fff;' class=hoverbox>
  <table cellspacing=0 celpadding=0 height=200 width=194>
    <tr>
  ...
  <div style="margin-left:30px;">
     ...
     <div style='font-size:10px;'>(with GST {$gst_price})</div>
       {if $notify==1}
     <div><a href="javascript:void(0); " onClick="loadPopupBox('notify_box_{$sku}');">Notify Me When Available</a></div> 
     {/if}
  </div>
  {*if $is_notify==1*}
  {if $notify==1}
     <div id="notify_box_{$sku}" class="notify_box">    <!-- OUR PopupBox DIV-->
    <a href="javascript:void(0); " onClick="unloadPopupBox('notify_box_{$sku}');" class="notify_boxClose">X Close</a>  
