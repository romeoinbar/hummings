	...
	<div id="newsletter" style='border:0px solid red;'>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td align="right"><input name="name" type="text" class="textinput" id="namex" size="30" placeholder="Name" style=" width:180px;" />
         <input name="email" type="text" class="textinput" id="emailx" value="" size="30" placeholder="Email"  style=" width:180px;"  />
         </td>
         <td align="left">&nbsp;
...
<div id="bottom_menu_box" style='border:0px solid red;  PADDING-TOP:5PX; height:420px;'>
	<div class="inner">
    	<div class="block2" style='padding-top:5px; border:0px solid red; width:140px;' >
          ...
          <div class="block11">
          {foreach from=$bottom_cats item=bottom_cat}
...
<div id="footer" style='margin-top:10px; '>	
  ...
  <tr>
    ...
    <div style="float:left; width:290px; margin-left:170px;">
    <img src="{$php5WebPath}/images/biz_safe3.png" height="55" hspace="25" vspace="10" align="left" />&nbsp;&nbsp;&nbsp;&nbsp;
...
<p style="color:#666; text-align:left; font-weight:normal; background-color:#fff; padding:20px;"><strong>Buy special flowers, gifts and hampers  online at <a href="{$php5WebPath}" style="color:#000;  text-decoration:underline;">Hummings.com</a></strong><br />
  ...
  <br />
  Getting married  or planning for your ROM? Our online store provides <a href="http://www.hummings.com/cart/eshop/product_detail/show/Comforting Memo_1199_353/" style="color:#000;  text-decoration:underline;">personalized  wedding banner</a> to help you achieve your dream wedding. <a href="{$php5WebPath}" style="color:#000;  text-decoration:underline;">Humming Flowers  &amp; Gifts</a> is the only florist and gift shop in Singapore to offer  personalized wedding banners for your newly-wed friends and loved ones. <br />
  <br />
