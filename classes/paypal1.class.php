...
class PayPal {
    ...
    public function __construct($sandboxflag = true){
        ...
        $this->version = 95;
        $this->currency_type = 'SGD';
        $this->payment_type = 'Sale'; //Authorization or Sale
        $this->buttoncode = 'PP-ECWizard';
        $this->cancel_url = 'http://www.hummings.com/cart/eshop/checkout/show/';
        ...
        if($sandboxflag){
            ...
            $this->api_username = 'jessheena_api1.noel.com.sg';
            $this->api_password = 'BGRAMA3PGXRY75C3';
            $this->api_signature = 'A3OSXvFL7djKs.Y2wJiEfQx3IecEAN2js966uXu3bZdMB.gFLhYgn5o0';
    ...
    public function setShortcutExpressCheckout($paymentAmount, $subtotal, $ship, $tax, $return_url, $description)
    {
        //------------------------------------------------------------------------------------------------------------------------------------
        // Construct the parameter string that describes the SetExpressCheckout API call in the shortcut implementation  
		$nvpstr = ""; 
		$nvpstr .= "&PAYMENTREQUEST_0_ITEMAMT=".$subtotal;  
		$nvpstr .= "&PAYMENTREQUEST_0_TAXAMT=".$tax;  
		$nvpstr .= "&PAYMENTREQUEST_0_SHIPPINGAMT=".$ship; 				 
		...
		$nvpstr .= "&LOGOIMG="							.urlencode("https://www.hummings.com/images/logo_hummings.png");
