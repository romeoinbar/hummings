...
if ($width)
{
	...
	{
		// if IE<=8
		return "<img style='background: no-repeat center center fixed;
     filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src=".$php5WebPath.'/'.$image.", sizingMethod=scale);' src='".$php5WebPath."/images/out_of_stock.png' width=$r_width height=$r_height>";
