...
$dblink = connectdb($php5Config['db_name_en']);
...
**/		   
	 ...
	 function get_occasions($product_id)
	 {
		 ...
		 global $php5DB_en;
          ...
          $query = "SELECT * FROM #__product_category_link as a LEFT JOIN  #__product_category as b ON a.product_category_id=b.product_category_id   WHERE a.product_id= '$product_id' AND b.category_type=2";
		  $php5DB_en->setQuery( $query );  
	 ...
	 function image($width,$height)
	 {
         ...
         return return_resized_image($width, $height, display_image_url($this->image));	
