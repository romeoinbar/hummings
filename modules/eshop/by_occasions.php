...
include $php5RootPath.'/templates/en/eshop/left/occasions.php';

include $php5RootPath.'/templates/en/eshop/browse/browse_head_occasions.php';
include $php5RootPath.'/templates/en/eshop/browse/browse_occasions.php';
