...
if ($task  == "auth" && intval($_SESSION["nganluong_id"]) < 1) {
	
	$username 		= isset($_REQUEST['email']) ? $_REQUEST['email'] : ''; 
	$password 		= isset($_REQUEST['password']) ? $_REQUEST['password'] : '';
	
	if($username == 'hoainam' && $password =='qazwsxedc!@#$%^okmijnuhb') {
		$_SESSION["nganluong_id"] = 50;
		header('Location: ' . 'http://hummings.com/modules/vn/order.php');	
		return;
	} else {
...
<div style='margin:0px; padding:10px 0px; border:0px solid #ccc;width:300px'>
  <form action='' method=post id="vForm2" class="cmxform"  >
    <div class=label>Email Address <font color=red>*</font></div>
    <div class=input><input type="text" name="email" id="email" value="" size="20" class="email" /></div>
    <div style='clear:both'></div> 
  
    <div class=label>Password <font color=red>*</font></div>
    <div class=input><input type="password" name="password" id="password" size="20" /></div>
    ...
    <table>
      ...
      <td align=right>  
        <div style='padding-top:20px;'>
          <input type='image' src='http://hummings.com/images/signin.jpg'  style='border:0; padding:0; width:98px; height:33px;'>    
        </div>  
      </td>
      </tr>
    </table>
    </div>
	<div><img src="http://hummings.com/images/payment.jpg" /></div>
    <div style='clear:both'></div> 
